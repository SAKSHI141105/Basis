...
export function ArchitectureDiagram() {
  return (
    ...
    >
      ...
      {/* Online serving */}
      <rect x="220" y="180" width="460" height="130" rx="8" style={box} strokeWidth="1.5" />
      ...
      {["POST /classify", "POST /draft-reply", "POST /decide", "POST /pipeline (chains all three)"].map(
        (ep, i) => (
          <text key={ep} x={240} y={232 + i * 22} fontSize="12.5" style={labelStyle}>
            {ep}
          </text>
        )
      )}
      ...
      {/* branch lines */}
      <line x1="330" y1="310" x2="200" y2="350" style={lineStyle} strokeWidth="1.5" markerEnd="url(#arrow)" />
      <line x1="570" y1="310" x2="700" y2="350" style={lineStyle} strokeWidth="1.5" markerEnd="url(#arrow)" />

      {/* Eval harness */}
      <rect x="40" y="356" width="340" height="70" rx="8" style={box} strokeWidth="1.5" />
      <text x="60" y="382" fontSize="11" style={subLabelStyle} letterSpacing="0.06em">
        EVALUATION HARNESS
      </text>
      <text x="60" y="406" fontSize="12.5" style={labelStyle}>
        golden_set.jsonl → eval_report.json / .md
      </text>

      {/* Demo frontend */}
      <rect x="500" y="356" width="360" height="70" rx="8" style={box} strokeWidth="1.5" />
      <text x="520" y="382" fontSize="11" style={subLabelStyle} letterSpacing="0.06em">
        DEMO FRONTEND (this app)
      </text>
      <text x="520" y="406" fontSize="12.5" style={labelStyle}>
