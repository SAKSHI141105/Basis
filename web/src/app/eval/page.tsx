  ...
  return (
    <div className="mx-auto max-w-[1120px] px-6 py-16">
      ...
      <Reveal className="mt-9">
        <section className="hover-lift rounded-xl border border-warning-border bg-warning-bg p-7 shadow-[var(--shadow-card)]">
            ...
            <table className="w-full border-collapse text-[13px]">
              ...
              <tbody>
                {Object.entries(report.intent_metrics.main.per_intent_f1)
                  .sort((a, b) => a[1] - b[1])
                  .map(([intent, f1]) => (
                    <tr key={intent} className="border-b border-border last:border-0 bg-surface transition-colors hover:bg-surface-2">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {Object.entries(report.judge_summary).map(([k, v]) => (
                <div
                  key={k}
                  className="hover-lift rounded-xl border border-border bg-surface p-5 shadow-[var(--shadow-card)]"
                >
          ...
          <section>
            ...
            <div className="flex flex-col gap-3">
              {report.failure_examples.map((f) => (
                <div
                  key={f.thread_id}
                  className="hover-lift rounded-xl border border-border bg-surface p-6 shadow-[var(--shadow-card)]"
                >
